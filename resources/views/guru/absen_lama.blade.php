      ...
      <form action="{{ route('absen.simpan') }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" id="id_card" name="id_card" maxlength="5" onkeypress="return inputAngka(event)" class="form-control @error('id_card') is-invalid @enderror" value="{{ auth()->user()->id_card }}" readonly>
            </div>
            <div class="form-group">
